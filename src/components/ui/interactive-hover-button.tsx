...
>(({ text = "Try for Free", className, ...props }, ref) => {
  return (
    <button
      ref={ref}
      className={cn(
        "group relative w-36 cursor-pointer overflow-hidden rounded-md border bg-background p-2 text-center text-sm ",
        className
      )}
      {...props}
    >
